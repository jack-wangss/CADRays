...
void AppGui::Draw (AIS_InteractiveContext* theAISContext, V3d_View* theView, bool theHasFocus)
{
  ...
  if (ImGui::BeginMainMenuBar())
  {
    ...
    if (toSave)
    {
      ...
      Image_Format aFormat = Image_Format::Image_Format_RGB;
      ...
      {
        // dump HDR image
        aFormat = Image_Format::Image_Format_RGBF;
      ...
      else
      {
        if (!toShowSaveDialog)
        {
          ...
          // dump LDR image
          aFormat = Image_Format::Image_Format_RGB;
...
void AppGui::SetupImGuiStyle()
{
    ...
    auto linearColorToSrgb = [](const ImVec4& linearColor)
        {
            ImVec4 srgbColor;
            srgbColor.x = pow(linearColor.x, 2.2f);
            srgbColor.y = pow(linearColor.y, 2.2f);
            srgbColor.z = pow(linearColor.z, 2.2f);
            srgbColor.w = linearColor.w;
            return srgbColor;
        };
  ImGuiStyle& style = ImGui::GetStyle();
  style.Colors[ImGuiCol_Text]                  =linearColorToSrgb(ImVec4(0.93f, 0.94f, 0.95f, 1.00f));
  style.Colors[ImGuiCol_TextDisabled]          =linearColorToSrgb(ImVec4(0.93f, 0.94f, 0.95f, 0.58f));
  style.Colors[ImGuiCol_WindowBg]              =linearColorToSrgb(ImVec4(0.24f, 0.24f, 0.24f, 1.00f));
  style.Colors[ImGuiCol_ChildWindowBg]         =linearColorToSrgb(ImVec4(0.13f, 0.13f, 0.13f, 0.00f));
  style.Colors[ImGuiCol_PopupBg]               =linearColorToSrgb(ImVec4(0.13f, 0.13f, 0.13f, 0.82f));
  style.Colors[ImGuiCol_Border]                =linearColorToSrgb(ImVec4(0.39f, 0.39f, 0.39f, 0.31f));
  style.Colors[ImGuiCol_BorderShadow]          =linearColorToSrgb(ImVec4(0.13f, 0.13f, 0.13f, 0.00f));
  style.Colors[ImGuiCol_FrameBg]               =linearColorToSrgb(ImVec4(0.47f, 0.47f, 0.47f, 1.00f));
  style.Colors[ImGuiCol_FrameBgHovered]        =linearColorToSrgb(ImVec4(0.27f, 0.60f, 0.93f, 1.00f));
  style.Colors[ImGuiCol_FrameBgActive]         =linearColorToSrgb(ImVec4(0.35f, 0.67f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_TitleBg]               =linearColorToSrgb(ImVec4(0.31f, 0.31f, 0.31f, 1.00f));
  style.Colors[ImGuiCol_TitleBgCollapsed]      =linearColorToSrgb(ImVec4(0.31f, 0.31f, 0.31f, 0.75f));
  style.Colors[ImGuiCol_TitleBgActive]         =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_MenuBarBg]             =linearColorToSrgb(ImVec4(0.39f, 0.39f, 0.39f, 0.63f));
  style.Colors[ImGuiCol_ScrollbarBg]           =linearColorToSrgb(ImVec4(0.39f, 0.39f, 0.39f, 1.00f));
  style.Colors[ImGuiCol_ScrollbarGrab]         =linearColorToSrgb(ImVec4(0.22f, 0.54f, 0.86f, 1.00f));
  style.Colors[ImGuiCol_ScrollbarGrabHovered]  =linearColorToSrgb(ImVec4(0.27f, 0.60f, 0.93f, 1.00f));
  style.Colors[ImGuiCol_ScrollbarGrabActive]   =linearColorToSrgb(ImVec4(0.35f, 0.67f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_ComboBg]               =linearColorToSrgb(ImVec4(0.39f, 0.39f, 0.39f, 1.00f));
  style.Colors[ImGuiCol_CheckMark]             =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 0.98f));
  style.Colors[ImGuiCol_SliderGrab]            =linearColorToSrgb(ImVec4(0.22f, 0.54f, 0.86f, 1.00f));
  style.Colors[ImGuiCol_SliderGrabActive]      =linearColorToSrgb(ImVec4(0.35f, 0.67f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_Button]                =linearColorToSrgb(ImVec4(0.22f, 0.54f, 0.86f, 1.00f));
  style.Colors[ImGuiCol_ButtonHovered]         =linearColorToSrgb(ImVec4(0.27f, 0.60f, 0.93f, 1.00f));
  style.Colors[ImGuiCol_ButtonActive]          =linearColorToSrgb(ImVec4(0.35f, 0.67f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_Header]                =linearColorToSrgb(ImVec4(0.24f, 0.24f, 0.24f, 1.00f));
  style.Colors[ImGuiCol_HeaderHovered]         =linearColorToSrgb(ImVec4(0.27f, 0.60f, 0.93f, 1.00f));
  style.Colors[ImGuiCol_HeaderActive]          =linearColorToSrgb(ImVec4(0.35f, 0.67f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_Column]                =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 0.32f));
  style.Colors[ImGuiCol_ColumnHovered]         =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 0.78f));
  style.Colors[ImGuiCol_ColumnActive]          =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_ResizeGrip]            =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 0.00f));
  style.Colors[ImGuiCol_ResizeGripHovered]     =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 0.78f));
  style.Colors[ImGuiCol_ResizeGripActive]      =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_CloseButton]           =linearColorToSrgb(ImVec4(0.93f, 0.94f, 0.95f, 0.16f));
  style.Colors[ImGuiCol_CloseButtonHovered]    =linearColorToSrgb(ImVec4(0.93f, 0.94f, 0.95f, 0.39f));
  style.Colors[ImGuiCol_CloseButtonActive]     =linearColorToSrgb(ImVec4(0.93f, 0.94f, 0.95f, 1.00f));
  style.Colors[ImGuiCol_PlotLines]             =linearColorToSrgb(ImVec4(0.93f, 0.94f, 0.95f, 0.63f));
  style.Colors[ImGuiCol_PlotLinesHovered]      =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_PlotHistogram]         =linearColorToSrgb(ImVec4(0.93f, 0.94f, 0.95f, 0.63f));
  style.Colors[ImGuiCol_PlotHistogramHovered]  =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 1.00f));
  style.Colors[ImGuiCol_TextSelectedBg]        =linearColorToSrgb(ImVec4(0.20f, 0.60f, 1.00f, 0.43f));
  style.Colors[ImGuiCol_ModalWindowDarkening]  =linearColorToSrgb(ImVec4(0.31f, 0.31f, 0.31f, 0.73f));
