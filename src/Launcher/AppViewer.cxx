    ...
    myCameraMovingData (new AppViewer_Camera)
{
  ...
  a3DViewer->SetDefaultViewProj(V3d_XposYnegZpos);
...
void AppViewer::Run()
{
  ...
  if (myTestingData != NULL)
  {
    ...
    {
      if (myTestingData->PixMap.InitZero (Image_Format::Image_Format_RGB, Standard_Size(myRTSize.x), Standard_Size(myRTSize.y)))
      {
